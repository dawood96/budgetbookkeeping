                ...
                <div class="card border-left-success border-left-success-balance shadow h-100 py-2">
                    <div class="card-body">
                        <div class="row no-gutters align-items-center">
                            ...
                            <div class="col-auto">
                                <i class="fas fa-5x fa-money-bill-wave zoom-in"></i>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="row">
                <div class="col-md-4 offset-md-4 form-div login">
                    <form method="POST" data-ajax="false" action="IncomeDesign.php">
                        <h3 class="text-center font-weight-bold text-uppercase">Add Income</h3><br>
                   ...
                   ?>
                        ...
                        ?>
                            <button type="submit" class="btn btn-success rounded-pill" name="add_income">ADD <i
